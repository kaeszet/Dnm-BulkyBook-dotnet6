...
namespace BulkyBook.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        {
            var orderHeaderDb = _unitOfWork.OrderHeader.GetFirstOrDefault(x => x.Id == OrderVM.OrderHeader.Id, tracked: false);
            ...
            if (OrderVM.OrderHeader.Carrier != null) orderHeaderDb.Carrier = OrderVM.OrderHeader.Carrier;
            if (OrderVM.OrderHeader.TrackingNumber != null) orderHeaderDb.TrackingNumber = OrderVM.OrderHeader.TrackingNumber;
        ...
        public IActionResult ShipOrder()
        {
            ...
            if (orderHeader.PaymentStatus == SD.PaymentStatusDelayedPayment) orderHeader.PaymentDueDate = DateTime.Now.AddDays(30);
